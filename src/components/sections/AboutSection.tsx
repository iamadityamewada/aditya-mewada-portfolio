...
import { Award, Users, FolderGit2 } from 'lucide-react'; // Updated icons
...
const AboutSection: React.FC<AboutSectionProps> = ({ id }) => {
  ...
  return (
    <Section id={id} className="bg-background">
      {/* Using subtitle prop for consistency */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] lg:w-[400px] lg:h-[400px] aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-primary via-transparent to-transparent p-1 shadow-lg">
             <div className="bg-background rounded-[calc(1.5rem-4px)] h-full w-full overflow-hidden"> {/* Slightly smaller inner radius */}
                <Image
                    src="https://picsum.photos/seed/aboutme/400/400" // Placeholder, replace with actual image
                    alt="Aditya Mewada"
                    width={400}
                    height={400}
          ...
          {/* Experience/Project Cards */}
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 w-full max-w-lg lg:max-w-none">
            <Card className="bg-card hover:bg-secondary transition-colors text-center p-6 shadow-md">
             ...
             {/* Add Clients/Certifications card if applicable
             <Card className="bg-card hover:bg-secondary transition-colors text-center p-6 shadow-md">
               <CardHeader className="p-0 mb-3">
                 <Users className="h-6 w-6 mx-auto text-primary" />
               </CardHeader>
               <CardContent className="p-0">
                 <CardTitle className="text-lg font-semibold mb-1">Clients</CardTitle>
                 <CardDescription className="text-sm text-muted-foreground">
                   5+ Worldwide <br/> (Example)
                 </CardDescription>
               </CardContent>
             </Card> */}
            <Card className="bg-card hover:bg-secondary transition-colors text-center p-6 shadow-md">
